...
namespace LZ
{
    internal class BinTree : InWindow
    {
        ...
        internal new void SetStream(System.IO.Stream stream)
        {
            base.SetStream(stream);
        }

        internal new void ReleaseStream()
        {
            base.ReleaseStream();
        }
        ...
        internal new Byte GetIndexByte(Int32 index)
        {
        ...
        internal new UInt32 GetNumAvailableBytes()
        {
        ...
        internal void SetCutValue(UInt32 cutValue)
        {
            _cutValue = cutValue;
        }
    }
