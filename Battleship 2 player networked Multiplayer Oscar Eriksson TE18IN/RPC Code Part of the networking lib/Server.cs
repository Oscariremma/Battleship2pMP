...
namespace RemoteProcedureCalls
{
    ...
    public static class Server
    {
        ...
        public static void ShutdownAllRPC()
        {
            lock (locker)
            {
                ...
                foreach (var handlerPair in newConnectionByNewInstanceHandlers)
                {
                    ...
                    serverConnection.RemoveIncomingPacketHandler(name, handlerPair.Value as NetworkComms.PacketHandlerCallBackDelegate<string>);
                }
        ...
        #endregion RPC Network comms handlers
    }
}